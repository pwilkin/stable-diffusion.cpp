...
struct SDContextParams {
    ...
    std::string hf_clip_l;
    std::string clip_g_path;
    std::string hf_clip_g;
    std::string clip_vision_path;
    std::string hf_clip_vision;
    std::string t5xxl_path;
    std::string hf_t5xxl;
    std::string llm_path;
    std::string hf_llm;
    std::string llm_vision_path;
    std::string hf_llm_vision;
    std::string diffusion_model_path;
    std::string hf_diffusion_model;
    std::string high_noise_diffusion_model_path;
    std::string hf_high_noise_diffusion_model;
    std::string uncond_diffusion_model_path;
    std::string hf_uncond_diffusion_model;
    std::string embeddings_connectors_path;
    std::string hf_embeddings_connectors;
    std::string vae_path;
    std::string hf_vae;
    std::string vae_format = "auto";
    std::string audio_vae_path;
    std::string hf_audio_vae;
    std::string taesd_path;
    std::string hf_taesd;
    std::string esrgan_path;
    std::string hf_esrgan;
    std::string control_net_path;
    std::string hf_control_net;
    std::string embedding_dir;
    std::string photo_maker_path;
    std::string hf_photo_maker;
    std::string pulid_weights_path;
    std::string hf_pulid_weights;
    std::string hf_token;
